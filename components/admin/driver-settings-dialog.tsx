...
export function DriverSettingsDialog({ open, onOpenChange, driver }: DriverSettingsDialogProps) {
  ...
  const handleSave = () => {
    ...
    console.log("[v0] Saving driver settings", {
      driverId: driver.id,
      notifications: {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Configure settings and preferences for {driver.name} ({driver.id})
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="notifications" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Choose how the driver receives notifications</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="email-notifications">Email Notifications</Label>
                    <p className="text-sm text-muted-foreground">Send notifications to {driver.email}</p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm text-muted-foreground">Send SMS to {driver.phone}</p>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure which alerts the driver should receive</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="job-alerts">Job Assignment Alerts</Label>
                    <p className="text-sm text-muted-foreground">New jobs and route updates</p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="maintenance-alerts">Vehicle Maintenance Alerts</Label>
                    <p className="text-sm text-muted-foreground">Service schedules and vehicle issues</p>
                  </div>
          ...
          <TabsContent value="permissions" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Control what features and data the driver can access</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="portal-access">Driver Portal Access</Label>
                    <p className="text-sm text-muted-foreground">Access to web-based driver portal</p>
                  </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Enable or disable specific features for this driver</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <Label htmlFor="log-defects">Log Vehicle Defects</Label>
                    <p className="text-sm text-muted-foreground">Report vehicle issues and defects</p>
                  </div>
          ...
          <TabsContent value="communication" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Configure how to best reach this driver</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
          ...
          <TabsContent value="devices" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Settings for the driver's mobile application</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-0.5">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Devices currently linked to this driver</CardDescription>
              </CardHeader>
              <CardContent className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 border rounded-lg">
                  <div className="flex items-center space-x-3">
                    <Smartphone className="h-5 w-5 text-muted-foreground" />
                    <div>
                      <p className="font-medium text-sm">iPad Air</p>
