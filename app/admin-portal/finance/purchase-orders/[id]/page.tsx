...
import { EditPODialog } from "@/components/admin/edit-po-dialog"
...
export default function AdminPurchaseOrderDetailsPage({ params }: { params: { id: string } }) {
  const { id } = params
  const [isEditDialogOpen, setIsEditDialogOpen] = useState(false)

  // Mock data - in production, fetch by ID from database
  ...
  const purchaseOrderDetails = purchaseOrders[id as keyof typeof purchaseOrders]
      ...
      <div className="min-h-screen bg-background">
        <div className="p-6">
          <Card className="p-12 text-center">
            ...
            <Link href="/admin-portal/finance/purchase-orders">
              <Button>
    ...
    <>
      <div className="bg-background border-b border-border px-6 py-3">
        <div className="flex items-center gap-2 text-sm">
          <Link href="/admin-portal/finance/purchase-orders" className="text-orange-500 font-medium hover:underline">
            Finance
          </Link>
          <span className="text-muted-foreground">›</span>
          <Link href="/admin-portal/finance/purchase-orders" className="text-foreground hover:underline">
            Purchase Orders
          </Link>
          <span className="text-muted-foreground">›</span>
          ...
          <Card className="p-6">
            ...
            <div className="grid grid-cols-4 gap-6">
              ...
              <div>
                ...
                <div className="font-semibold text-lg text-primary">{purchaseOrderDetails.client}</div>
              </div>
              <div>
                <div className="flex items-center gap-2 text-sm text-muted-foreground mb-1">
              ...
              {purchaseOrderDetails.invoiceNumber && (
                <div>
                  <div className="flex items-center gap-2 text-sm text-muted-foreground mb-1">
                    <Hash className="w-4 h-4" />
                    Invoice Number
                  </div>
                  <div className="font-semibold text-lg text-green-600">{purchaseOrderDetails.invoiceNumber}</div>
                </div>
              )}
            </div>
          </Card>
                ...
                <div key={idx} className="p-4 bg-gray-50 rounded-lg border border-border">
                  <div className="grid grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-semibold">{item.deliveryTime}</div>
                    </div>
