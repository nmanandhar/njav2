...
const statements = [
  ...
  {
    id: "STMT-2024-01-MEL",
    statementNumber: "STMT-2024-01-MEL",
  ...
  {
    id: "STMT-2023-12-NJA",
    statementNumber: "STMT-2023-12-NJA",
    client: "N J Ashton",
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex-1 max-w-md relative">
              ...
              <Input type="text" placeholder="Search by statement number, client, period..." className="pl-9" />
            </div>
              ...
              <Card key={statement.id} className="p-6">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  ...
                  <div className="lg:col-span-3 space-y-3">
                    <div>
                      <Link
                        href={`/admin-portal/finance/statements/${statement.id}`}
                    ...
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                          <Link href={`/admin-portal/finance/statements/${statement.id}`}>
