...
const statements = [
  ...
  {
    id: "STMT-2023-12-XYZ",
    statementNumber: "STMT-2023-12-XYZ",
    period: "December 2023",
    startDate: "2023-12-01",
    endDate: "2023-12-31",
    issueDate: "2024-01-01",
    invoiceCount: 9,
    totalInvoiced: 27340.0,
    totalPaid: 27340.0,
  ...
  {
    id: "STMT-2023-11-XYZ",
    statementNumber: "STMT-2023-11-XYZ",
    period: "November 2023",
    startDate: "2023-11-01",
    endDate: "2023-11-30",
    issueDate: "2023-12-01",
    invoiceCount: 7,
    totalInvoiced: 21680.0,
    totalPaid: 21680.0,
    totalOutstanding: 0.0,
    status: "Paid",
  },
...
export default function SubcontractorStatementsPage() {
  return (
            ...
            <Card key={statement.id} className="p-6">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-3 space-y-3">
                  <div>
                    <Link
                      href={`/subcontractor-dashboard/finance/statements/${statement.id}`}
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem asChild>
                        <Link href={`/subcontractor-dashboard/finance/statements/${statement.id}`}>
